...
public class ConfiguracaoSeguranca extends WebSecurityConfigurerAdapter {
	...
	public UserDetailsService userDetailsServiceBean() throws Exception {
		DetalheTreinadorServico detalheDoTreinador = new DetalheTreinadorServico(treinadorService);
		return detalheDoTreinador;
	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/auth/user/*").hasAnyAuthority("USER","ADMIN","LIDER")
		.antMatchers("/auth/admin/*").hasAnyAuthority("ADMIN")
		.antMatchers("/auth/lider/*").hasAnyAuthority("LIDER")
		.antMatchers("/treinador/admin/*").hasAnyAuthority("ADMIN")
		.and()
